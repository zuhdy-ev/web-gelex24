...
export default function LatarBelakang() {
  return (
    <div className="relative flex h-[130vh] w-full flex-col justify-end md:h-[200vh] lg:h-[260vh]">
      {/* Latar Belakang */}
      <div className="mepet:-translate-y-[30vw] laptopL:-translate-0 absolute flex h-full w-full -translate-y-[90vw] items-center justify-center md:-translate-y-[30vw] lg:-translate-y-[10vw]">
        <Image
