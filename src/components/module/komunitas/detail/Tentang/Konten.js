  ...
  return (
    <div className="mt-10 flex h-[130vh] w-screen flex-col items-center lg:mt-20">
      ...
      <div className="flex w-full flex-col items-center justify-center gap-3">
        ...
        {/* Konten */}
        <div className="scrollbar-list h-[400px] w-[90%] overflow-y-auto rounded-lg border-2 border-[#E6A263] bg-black bg-opacity-50 p-5 text-justify text-[12px] text-white s:text-[15px] lg:h-[500px] lg:w-[900px] lg:border-[5px] lg:text-[18px] laptopL:w-[1080px]">
